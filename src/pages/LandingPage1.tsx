...
const LandingPage1 = () => {
  ...
  return (
    <div data-aos-offset="0" className="w-full relative bg-gradient-to-tr bg-white bg-center bg-cover bg-no-repeat min-h-screen flex flex-col justify-center items-center ">
